...
public class FlatBottomCalculateService : ICalculateService<FlatBottomInput>
{
    private readonly IPhysicalDataService _physicalData;
    public FlatBottomCalculateService(IPhysicalDataService physicalData)
    {
    ...
    public ICalculatedElement Calculate(FlatBottomInput dataIn)
    {
