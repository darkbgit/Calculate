...
public class ColumnSkirtCalculated : CalculatedElement, ICalculatedElement
{
    public ColumnSkirtCalculated()
    {
        Bibliography = new[]
        {
    ...
    public ICollection<string> ErrorList => throw new System.NotImplementedException();
