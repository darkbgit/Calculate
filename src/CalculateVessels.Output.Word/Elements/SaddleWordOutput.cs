...
internal class SaddleWordOutput : IWordOutputElement<SaddleCalculated>
{
    public void MakeWord(string filePath, ICalculatedElement calculatedData)
    {
        if (calculatedData is not SaddleCalculated data)
            throw new NullReferenceException();

        var dataIn = (SaddleInput)data.InputData;
