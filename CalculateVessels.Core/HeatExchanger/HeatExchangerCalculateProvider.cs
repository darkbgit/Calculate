...
{
    internal class HeatExchangerCalculateProvider : ICalculateProvider
    {
        public ICalculatedData Calculate(IInputData inputData)
        {
            if (inputData is not HeatExchangerInputData dataIn)
                throw new CalculateException("Error. Input data wrong type.");

            var data = new HeatExchangerCalculatedData(dataIn);

            //TODO: Get physical parameters
            //ET
            try
            {
                data.ET = Physical.GetE(dataIn.SteelT, dataIn.TT);
            }
            ...
            try
            {
                data.EK = Physical.GetE(dataIn.SteelK, dataIn.TK);
            }
            catch (PhysicalDataException e)
            {
                throw new CalculateException("Error get E.", e);
            ...
            try
            {
                data.ED = Physical.GetE(dataIn.FirstTubePlate.SteelD, dataIn.TT);
            }
            catch (PhysicalDataException e)
            {
                throw new CalculateException("Error get E.", e);
            ...
            if (dataIn.IsDifferentTubePlate)
            {
                try
                {
                    data.ED2 = Physical.GetE(dataIn.SecondTubePlate.SteelD, dataIn.TT);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Error get E.", e);
            ...
            try
            {
                data.Ep = Physical.GetE(dataIn.FirstTubePlate.Steelp, dataIn.TK);
            }
            catch (PhysicalDataException e)
            {
                throw new CalculateException("Error get E.", e);
            ...
            if (dataIn.IsDifferentTubePlate)
            {
                try
                {
                    data.Ep2 = Physical.GetE(dataIn.SecondTubePlate.Steelp, dataIn.TK);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Error get E.", e);
            ...
            else
            {
                try
                {
                    data.E1 = Physical.GetE(dataIn.FirstTubePlate.Steel1, dataIn.TK);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Error get E.", e);
            ...
            if (dataIn.IsDifferentTubePlate)
            {
                ...
                else
                {
                    try
                    {
                        data.E12 = Physical.GetE(dataIn.SecondTubePlate.Steel1, dataIn.TK);
                    }
                    catch (PhysicalDataException e)
                    {
                        throw new CalculateException("Error get E.", e);
            ...
            try
            {
                data.E2 = Physical.GetE(dataIn.FirstTubePlate.Steel2, dataIn.TK);
            }
            catch (PhysicalDataException e)
            {
                throw new CalculateException("Error get E.", e);
            ...
            if (dataIn.IsDifferentTubePlate)
            {
                ...
                try
                {
                    data.E22 = Physical.GetE(dataIn.SecondTubePlate.Steel2, dataIn.TK);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Error get E.", e);
            ...
            if (dataIn.IsNeedKcompensatorCalculate)
            {
                //Ekom
                try
                {
                    data.Ekom = Physical.GetE(dataIn.Steelkom, dataIn.TK);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Error get E.", e);
            ...
            try
            {
                data.alfaK = Physical.GetAlpha(dataIn.SteelK, dataIn.TK);
            }
            catch (PhysicalDataException e)
            {
            ...
            try
            {
                data.alfaT = Physical.GetAlpha(dataIn.SteelT, dataIn.TT);
            }
            catch (PhysicalDataException e)
            {
                throw new CalculateException("Error get alpha.", e);
            ...
            {
                throw new CalculateException("Error get Rmp.", e);
            }
            if (dataIn.IsDifferentTubePlate)
            {
                try
            ...
            data.nNForSigmaa = 10.0;
            data.nsigmaForSigmaa = 2.0;

            data.CtForSigmaa = (2300.0 - dataIn.TK) / 2300.0;
            ...
            switch (dataIn.CompensatorType)
            {
                ...
                case CompensatorType.Expander:
                    ...
                    {
                        data.Ap1 = 2 /
                            (Math.Sin(DegToRad(dataIn.beta0)) * Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 2)) *
                            Math.Log(1.0 / data.betap);
                        data.Ap2 = 1.82 * Math.Pow(Math.Sin(DegToRad(dataIn.beta0)), 2) *
                            (1 + Math.Sqrt(data.betap)) / Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 3.0 / 2.0);
                        data.Bp1 = -1.06 /
                            (Math.Sin(DegToRad(dataIn.beta0)) * Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 2)) *
                            (Math.Log(1 / data.betap) + (1.0 / Math.Pow(data.betap, 2) - 1) *
                                (0.3 * Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 4) +
                                 1.5 * Math.Pow(Math.Sin(DegToRad(dataIn.beta0)), 2) -
                                 0.5 * Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 2) +
                                 Math.Pow(Math.Sin(DegToRad(dataIn.beta0)), 4)));
                        data.Bp2 = 0.965 * Math.Pow(Math.Sin(DegToRad(dataIn.beta0)), 2) /
                            Math.Pow(Math.Cos(DegToRad(dataIn.beta0)), 3.0 / 2.0 *
            ...
            try
            {
                (data.Phi1, data.Phi2, data.Phi3) = Physical.Gost34233_7.TryGetPhi1Phi2Phi3(data.omega);
            }
            catch (PhysicalDataException e)
            {
            ...
            if (data.mA is >= -1.0 and <= 1.0)
            {
                try
                {
                    data.A = Physical.Gost34233_7.GetA(data.omega, data.mA);
                }
                catch (PhysicalDataException e)
                {
            ...
            else
            {
                ...
                try
                {
                    data.B = Physical.Gost34233_7.GetB(data.omega, data.nB);
                }
                catch (PhysicalDataException e)
                {
            ...
            if (dataIn.FirstTubePlate.IsNeedCheckHardnessTubePlate)
            {
                ...
                try
                {
                    data.W_d = Physical.Gost34233_7.GetpW_d(dataIn.D);
                }
                catch (PhysicalDataException e)
                {
                    throw new CalculateException("Couldn't get W_d", e);
                }
            ...
            if (!dataIn.IsOneGo && dataIn.FirstTubePlate.IsWithGroove)
            {
