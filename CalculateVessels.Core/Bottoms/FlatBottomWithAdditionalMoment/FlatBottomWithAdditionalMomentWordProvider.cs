...
{
    internal class FlatBottomWithAdditionalMomentWordProvider : IWordProvider
    {
        public void MakeWord(string filePath, ICalculatedData calculatedData)
        {
            if (calculatedData is not FlatBottomWithAdditionalMomentCalculatedData data)
                throw new NullReferenceException();

            var dataIn = (FlatBottomWithAdditionalMomentInputData)data.InputData;
            ...
            {
                body.AddParagraph("")
                        .AppendEquation($"K_6=0,41∙√((1+3∙{data.psi1:f2}({dataIn.D3}/{data.Dcp:f2}-1)+9.6∙{dataIn.D3}/{data.Dcp:f2}∙{dataIn.s4}/{data.Dcp:f2})/({dataIn.D3}/{data.Dcp:f2}))={data.K6:f2}");
            }
            else
            {
                body.AddParagraph("")
                        .AppendEquation($"K_6=0,41∙√((1+3∙{data.psi1:f2}({dataIn.D3}/{data.Dcp:f2}-1))/({dataIn.D3}/{data.Dcp:f2}))={data.K6:f2}");
            }

            body.AddParagraph("").AppendEquation($"s_1p={data.K0:f2}∙{data.K6:f2}∙{data.Dp:f2}∙√({dataIn.p}/({dataIn.fi}∙{dataIn.sigma_d}))={data.s1p:f2} мм");
            ...
            body.AddParagraph("").AppendEquation("Φ=max{P_б^p/[σ]^p;P_б^м/[σ]^м}" +
                $"=max{{{data.Pbp:f2}/{dataIn.sigma_d};{data.Pbm:f2}/{data.sigma_d_krm:f1}}}" +
            ...
            body.AddParagraph("")
                        .AppendEquation($"K_7=0.8∙√(D_3/D_сп-1)=0.8∙√({dataIn.D3}/{data.Dcp:f2}-1)={data.K7Fors2:f2}");

            body.AddParagraph("").AppendEquation($"K_7∙√(Φ)={data.K7Fors2:f2}∙√({data.Phi:f2})={data.s2p_1:f2}");
            ...
            body.AddParagraph("")
                        .AppendEquation($"K_7=0.8∙√(D_3/D_2-1)=0.8∙√({dataIn.D3}/{dataIn.D2}-1)={data.K7Fors3:f2}");

            body.AddParagraph("").AppendEquation($"K_7∙√(Φ)={data.K7Fors3:f2}∙√({data.Phi:f2})={data.s3p_1:f2}");
            ...
            body.AddParagraph("")
                .AppendEquation("[p]=((s_1-c)/(K_0∙K_6∙D_p))^2∙[σ]∙φ"
                                + $"=(({dataIn.s1}-{data.c:f2})/({data.K0:f2}∙{data.K6:f2}∙{data.Dp:f2}))^2∙{dataIn.sigma_d}∙{dataIn.fi}"
                                + $"={data.p_d:f2} МПа");
